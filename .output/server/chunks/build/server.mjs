...
const _routes = [
  {
    name: "index",
    path: "/",
    component: () => import('./index-CzRJuc_k.mjs')
  },
  {
    name: "services",
    path: "/services",
    component: () => import('./services-C4KEay63.mjs')
  }
];
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-DgXbaEBB.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-DxpWKNKh.mjs'));
