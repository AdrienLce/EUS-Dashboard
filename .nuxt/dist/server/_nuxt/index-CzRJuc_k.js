...
import { L as LEVEL_COLORS, _ as _sfc_main$3, r as runAdapter, u as useStatusStore, a as useServices } from "./index-DzaJy2UO.js";
import { defineComponent, computed, mergeProps, unref, useSSRContext, ref, watch, withCtx, openBlock, createBlock, createVNode, createTextVNode } from "vue";
import { ssrRenderAttrs, ssrInterpolate, ssrRenderComponent, ssrRenderTeleport, ssrRenderList, ssrRenderAttr, ssrRenderClass } from "vue/server-renderer";
...
const _sfc_main$2 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    ...
    const lastUpdated = computed(() => {
      if (!props.snapshot?.timestamp) return null;
              ...
              ssrRenderList(__props.snapshots, (snap) => {
                ...
                if (snap.incidents.length > 0) {
                  ...
                  ssrRenderList(snap.incidents, (incident) => {
                    ...
                    if (incident.url) {
                      _push2(`<a${ssrRenderAttr("href", incident.url)} target="_blank" rel="noopener noreferrer" class="text-blue-500 hover:underline"> Voir détail → </a>`);
                    } else {
                      _push2(`<!---->`);
                    }
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            return [
              ...
              createTextVNode(" Gérer les services ")
            ];
          }
        }),
        _: 1
      ...
      _push(`</svg></div><div><p class="font-semibold text-lg">${ssrInterpolate(LEVEL_LABELS_GLOBAL[unref(globalLevel)])}</p><p class="text-white/80 text-sm">${ssrInterpolate(unref(enabledServices).length)} service${ssrInterpolate(unref(enabledServices).length > 1 ? "s" : "")} surveillé${ssrInterpolate(unref(enabledServices).length > 1 ? "s" : "")}</p></div></div>`);
      if (unref(enabledServices).length === 0) {
        _push(`<div class="text-center py-20"><div class="w-16 h-16 rounded-2xl bg-gray-100 flex items-center justify-center mx-auto mb-4"><svg class="w-8 h-8 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M13 10V3L4 14h7v7l9-11h-7z"></path></svg></div><h3 class="font-semibold text-gray-900 mb-1">Aucun service configuré</h3><p class="text-gray-500 text-sm mb-5">Ajoutez des services pour commencer la surveillance</p>`);
        _push(ssrRenderComponent(_component_NuxtLink, {
          to: "/services",
...
//# sourceMappingURL=index-CzRJuc_k.js.map
